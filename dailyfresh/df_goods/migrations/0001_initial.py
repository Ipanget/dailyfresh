# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-09-26 12:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_type_id', models.SmallIntegerField(choices=[(1, '新鲜水果'), (2, '海鲜水产'), (3, '猪牛羊肉'), (4, '禽类蛋品'), (5, '新鲜蔬菜'), (6, '速度食品')], default=1, verbose_name='商品类型')),
                ...
                ('goods_status_choice', models.SmallIntegerField(choices=[(0, '下线商品'), (1, '上线商品')], default=1, verbose_name='商品状态')),
            ],
            options={
                'db_table': 's_goods',
            },
